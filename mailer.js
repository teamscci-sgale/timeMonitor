...
const sendEmail = (type, file) => {
    ...
    employees.forEach(employee => {
        // Selects html and subject for message based on type passed into sendEmail()
